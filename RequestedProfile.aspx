<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="RequestedProfile.aspx.cs" Inherits="RequestedProfile" %>
        ...
        <tr>
            <td>
                <table id="table8" border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        <td style="width: 268px; height: 38px;">
                        </td>
        ...
        <tr>
            <td height="19" align="center" style="margin-left: 40px">
                <asp:SqlDataSource ID="DataSchool" runat="server" ConnectionString="<%$ ConnectionStrings:strcon %>"
                    ...
                    <SelectParameters>
                        <asp:SessionParameter Name="UserID" SessionField="FriendID" Type="String" />
                    </SelectParameters>
                </asp:SqlDataSource>
            </td>
        </tr>
        ...
        <tr>
            <td height="19" align="center">
                <asp:Label ID="lblHeader1" runat="server" Font-Bold="True" Font-Names="Tahoma" Font-Size="Large"
                    ForeColor="#17668D" Text="Employment"></asp:Label>
            </td>
        </tr>
        <tr>
            <td height="19">
