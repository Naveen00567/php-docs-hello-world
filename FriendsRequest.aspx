<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="FriendsRequest.aspx.cs" Inherits="FriendsRequest" %>
                    ...
                    <tr>
                        <td align="center">
                            <asp:Label ID="lblHeader" runat="server" Font-Bold="True" Font-Names="Tahoma" Font-Size="Large"
                                ForeColor="#17668D" Text="Friends Request"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td align="center">
                    ...
                    <tr>
                        <td align="center">
                            <asp:GridView ID="gvFriends" runat="server" BackColor="White" BorderColor="#E7E7FF"
                                ...
                                GridLines="Horizontal" HorizontalAlign="Center" AutoGenerateColumns="False" DataSourceID="SqlDataSourceFriendsList"
                            ...
                            <asp:SqlDataSource ID="SqlDataSourceFriendsList" runat="server" ConnectionString="<%$ ConnectionStrings:strcon %>"
                                SelectCommand="SELECT [UserID], [FriendsID] FROM [tblFriendsList] WHERE (([Status] = @Status) AND ([FriendsID] = @FriendsID))">
                                <SelectParameters>
                                    <asp:SessionParameter DefaultValue="Request" Name="Status" SessionField="Status"
                                        Type="String" />
                                    <asp:SessionParameter Name="FriendsID" SessionField="UserID" Type="String" />
                                </SelectParameters>
                            </asp:SqlDataSource>
                        </td>
                    </tr>
