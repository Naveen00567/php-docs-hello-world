<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Employeement.aspx.cs" Inherits="Employeement" %>
        ...
        <tr>
            <td>
                <table cellpadding="0" cellspacing="0" class="style2">
                    ...
                    <tr>
                        <td align="center">
                            <asp:Label ID="lblHeader" runat="server" Font-Bold="True" Font-Names="Tahoma" Font-Size="Large"
                                ForeColor="#17668D" Text="Employment Details"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td align="center">
                        ...
                        <td align="center">
                            <table cellpadding="0" cellspacing="0" class="style2">
                                <tr>
                                    ...
                                    <td align="center">
                                        <asp:TextBox ID="txtEmployement" runat="server" BorderColor="Black" 
                                            Width="389px" Height="110px" TextMode="MultiLine"></asp:TextBox>
                                        <br />
                                        <br />
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                                            ControlToValidate="txtEmployement" ErrorMessage="Field cannot be blank" 
                    ...
                    <tr>
                        <td align="center">
                            <asp:GridView ID="gvEmployeer" runat="server" BackColor="White" BorderColor="#E7E7FF"
